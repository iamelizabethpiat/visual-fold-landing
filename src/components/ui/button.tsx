  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        // Custom variants for The Visual Fold
        cta: "bg-deep-charcoal text-warm-white hover:bg-foreground/90 hover:scale-[1.02] tracking-wide uppercase text-xs font-medium px-8 py-4",
        hero: "bg-warm-white/10 text-warm-white border border-warm-white/30 backdrop-blur-sm hover:bg-warm-white/20 hover:border-warm-white/50 tracking-wide uppercase text-xs font-medium px-8 py-4",
        subtle: "bg-accent/50 text-foreground hover:bg-accent hover:scale-[1.01]",
      },
      size: {
